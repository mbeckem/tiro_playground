...
var Playground = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Playground, [{
    ...
    value: function _startCompilation() {
      var _this$state, compiler, currentSource, result;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _startCompilation$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _this$state = this.state, compiler = _this$state.compiler, currentSource = _this$state.currentSource;
              _context2.next = 4;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(asyncSetState(this, {
                compiling: true
              }));
            ...
            case 4:
              result = compiler === null || compiler === void 0 ? void 0 : compiler.compile(currentSource);
              _context2.next = 7;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(asyncSetState(this, {
                compiling: false,
                result: result
            ...
            case 9:
              ...
              console.error("Compilation failed", _context2.t0);
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          compiling = _this$state2.compiling,
          compiler = _this$state2.compiler,
...
//# sourceMappingURL=index.js.5481d1dc996067861cbf.hot-update.js.map